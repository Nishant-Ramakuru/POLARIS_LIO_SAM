...
# Create a workspace for the POLARIS_LIO_SAM
RUN mkdir -p /home/ubuntu/polaris_lio_sam_ws/src && cd /home/ubuntu/polaris_lio_sam_ws/src && \
    # Clone the package: POLARIS_LIO_SAM
    git clone --depth 1 https://github.com/Nishant-Ramakuru/POLARIS_LIO_SAM.git
# Build the POLARIS_GEM_e2 package
RUN cd /home/ubuntu/polaris_lio_sam_ws && \
